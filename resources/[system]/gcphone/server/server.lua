...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookbanco = "https://discord.com/api/webhooks/867462776002969620/66ve1tr-kLfXWTazUGWbXYwiC1pHLody37caBb1w-oRg3N7HqqzmxWs_98CKemferJbi"
...
function serviceMessage(phone, sourcePlayer, message, type)
	...
	if user_id then
		...
		elseif phone == "112" then
			...
			players = vRP.getUsersByPermission("medico.permissao")
