TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "CONECTADO",
		TSPassword = "bigassafado", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "hypexacademy.ts3dns.eu", -- TeamSpeak server address to be displayed on blocking screen
