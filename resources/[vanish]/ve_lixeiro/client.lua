    ...
    while true do
        ...
        if not trabalhando then 
            ...
            if DistCentral <= 15 then
                sleep = 4
                DrawMarker(21, central[1], central[2], central[3], 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 0,0,255,150, 1, 0, 0, 1)
        ...
        elseif trabalhando and not CarroSpawnado then
            ...
            if DistGaragem <= 15 then
                sleep = 4
                DrawMarker(21, garagem[1], garagem[2], garagem[3], 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 0,0,255,150, 1, 0, 0, 1)
        ...
        elseif trabalhando and CarroSpawnado then
            ...
            if not ComLixos and not acabou then
                if not PontoMarcado then
                    ...
                    if DistPonto < 15 then
                        ...
                        sleep = 4
                        DrawMarker(21, rota[PontoMarcado].x, rota[PontoMarcado].y, rota[PontoMarcado].z, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 0,0,255,150, 1, 0, 0, 1)
            ...
            elseif ComLixos and not acabou then
                if DistCarro < 30 then
                    sleep = 4
                    DrawMarker(0, xCar, yCar, zCar+3.0, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 0,0,255,150, 1, 0, 0, 1)
            ...
            elseif acabou then
                ...
                elseif ComLixos and not IsPedInAnyVehicle(ped) then
                    ...
                    if DistDescarga < 30 then
                        sleep = 4
                        DrawMarker(21, descargaCentral[1], descargaCentral[2], descargaCentral[3], 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 0,0,255,150, 1, 0, 0, 1)
