...
Citizen.CreateThread(function()
    while true do
        ...
        if etapa == 0 and not trabalhando then 
			...
			if dist < 15 then
				timeDistance = 4
                DrawMarker(21,ComecarTrabalho[1], ComecarTrabalho[2], ComecarTrabalho[3],0,0,0,0,0,0,0.5,0.5,0.5,66, 209, 235,150,1,0,0,1)	
				if dist <= 0.6 then
					timeDistance = 4
		...
		if etapa == 1 then
			...
			DrawMarker(21,Recepcao[1], Recepcao[2], Recepcao[3],0,0,0,0,0,0,0.5,0.5,0.5,66, 209, 235,150,1,0,0,1)	
		...
		if etapa == 2 then
			...
			DrawMarker(0,posMotinha[1], posMotinha[2], posMotinha[3]+1.6,0,0,0,0,0,0,0.5,0.5,0.5,66, 209, 235,200,1,0,0,1)
		...
		if etapa == 3 then
			...
			DrawMarker(21,Bar[1], Bar[2], Bar[3],0,0,0,0,0,0,0.5,0.5,0.5,66, 209, 235,150,1,0,0,1)	
		...
		if etapa == 5 then
			...
			if pizzasNaMoto > 0 then
				...
				if distPonto < 15 then
					timeDistance = 4
					DrawMarker(21,Entregas[sorteado].x, Entregas[sorteado].y, Entregas[sorteado].z,0,0,0,0,0,0,0.5,0.5,0.5, 66, 209, 235, 255, 1,0,0,1)
