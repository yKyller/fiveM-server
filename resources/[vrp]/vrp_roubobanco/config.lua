...
Config.BankRobbery = {
    [1] = {
        ...
        Doors = { 
            ...
            {Coords = vector3(252.95, 221.16, 101.68), Object = "hei_v_ilev_bk_safegate_pris", Heading = 161.87, WeldPosition = {C = vector3(253.53,221.00,100.68), H = 247.54}, Time = 2, Frozen = true}, 
            {Coords = vector3(261.36, 215.67, 101.68), Object = "hei_v_ilev_bk_safegate_pris", Heading = 63.237, WeldPosition = {C = vector3(261.25, 216.03, 100.68), H = 254.73}, Time = 2, Frozen = true},
