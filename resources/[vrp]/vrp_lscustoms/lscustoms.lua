...
local foraBennys = false

local garages = {
	[1] = { locked = false, camera = { x = -210.29, y = -1321.87, z = 30.89, heading = 206.36 }, driveout = { x = -210.29, y = -1321.87, z = 30.89, heading = 3.70 }, drivein = { x = -210.29, y = -1321.87, z = 30.89, heading = 3.70 }, outside = { x = -210.29, y = -1321.87, z = 30.89, heading = 3.70 }, inside = { x = -210.29, y = -1321.87, z = 30.89, heading = 3.70 }},
...
local function DriveOutOfGarage2()
	Citizen.CreateThread(function()
		local ped = PlayerPedId()
		local veh = GetVehiclePedIsUsing(ped)
					...
					for i,pos in ipairs(garages) do
						...
						if LSC_Config.oldenter then
							if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(1) then
								-- TriggerEvent("Notify","negado","Teste")
