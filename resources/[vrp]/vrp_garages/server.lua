...
local webhookvehs = "https://discord.com/api/webhooks/867271106938667028/hgniloPzl3PDRSUKXXQKy03rMweoJsLLauJHURTVY_5_mJmRr0MM_uY4Dm704QnUZuiP"
local webhookdesmanche = "https://discord.com/api/webhooks/867271270830571520/ihd-fjM5paba8ZmIrWy67RlrpsweUHOY2cvQXci9TLmWL143UfNRJMtnEmonLqOVCIBX"
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[17] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "policia.permissao" },
	[18] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "policia.permissao" },
-----------------------------------------------------------------------------------------------------------------------------------------
--[ DEPARTAMENTO MÉDICO ]----------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	[19] = { ['name'] = "Hospital", ['payment'] = false, ['perm'] = "medico.permissao" },
-----------------------------------------------------------------------------------------------------------------------------------------
--[ AEROPORTO ]----------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	[20] = { ['name'] = "Aeroporto", ['payment'] = false, ['public'] = true },
-----------------------------------------------------------------------------------------------------------------------------------------
---[ FORTHILLS ]-------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[617] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "medico.permissao" },
	[618] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[619] = { ['name'] = "ParamedicoH", ['payment'] = false, ['perm'] = "medico.permissao" },
	[620] = { ['name'] = "Motorista", ['payment'] = false, ['perm'] = "livre" },
	[621] = { ['name'] = "Triade", ['payment'] = false, ['perm'] = "triade.permissao" },
	[622] = { ['name'] = "Mecanico", ['payment'] = false, ['perm'] = "mecanico.permissao" },
...
function src.vehicleLock()
	...
	if user_id then
		...
		if vehicle and placa then
			...
			local vehiclePlateId = vRP.getUserByRegistration(placa)
			print("plateid")
			print(vehiclePlateId)

			-- local hasTrust = vRP.query("creative/checkVehiclePermission",{ ownerId = vehiclePlateId, permissionId = user_id, vehicle = vname })

			if user_id == vehiclePlateId then
				...
				if lock == 1 then
					...
					TriggerClientEvent("Notify",source,"importante","Veículo <b>desbloqueado</b> com sucesso.",5000)
				end
