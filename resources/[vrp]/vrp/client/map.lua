...
function tvRP.addMarker(m,x,y,z,sx,sy,sz,r,g,b,a,visible_distance)
	...
	if marker.g == nil then marker.g = 0 end
...
RegisterCommand("procurado",function(source,args)
	if standby > 0 then
		TriggerEvent("Notify","aviso","Procurado","Aguarde <b>"..standby.." segundos</b> até que tudo se acalme.")
	else
		TriggerEvent("Notify","aviso","Aviso","Não está sendo procurado.")
	end
end)
