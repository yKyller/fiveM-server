...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookjoins = "https://discord.com/api/webhooks/778093041084923946/cW4Ujfm2aC0VTi3SCLcc2pHfyOsdptA1fpiCtEEgzixp5W6S_geuG4q05tloqpoV1CIN"
local webhookexit = "https://discord.com/api/webhooks/778093405305176084/HOhi8-HloH4mgTGyiOLxkivceDQlZaHtUffIxp6paSrzB6ndR4I2yLbcbRf79gNjcuEi"
		...
		if user_id then
			...
			if not vRP.isBanned(user_id) then
				...
				if vRP.isWhitelisted(user_id) then
					...
					deferrals.done("Solicite sua whitelist em nosso Discord! [ Kyller#0001 ][ ID: "..user_id.." ]")
					TriggerEvent("queue:playerConnectingRemoveQueues",ids)
				end
			else
				deferrals.done("Você foi banido! [ Mais informações em: Kyller#0001 ] ")
				--print(user_id)
				TriggerEvent("queue:playerConnectingRemoveQueues",ids)
			end
		else
