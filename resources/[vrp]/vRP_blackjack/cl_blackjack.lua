...
cfg.blackjackTables = {
    ...
    [0] = {
        ...
        dealerHeading = 46.0,
        tablePos = vector3(1148.837, 269.747, -52.84095),
        tableHeading = 225.30934143066,
        distance = 1000.0,
        prop = 112404821
    },
    [1] = {
        ...
        dealerHeading = 222.2,
        tablePos = vector3(1151.84, 266.747, -52.84095),
        tableHeading = 45.309341430664,
        distance = 1000.0,
        prop = 112404821
    },
    [2] = {
        dealerPos = vector3(1143.97,263.63,-51.84),
        dealerHeading = 46.0,
    ...
    [3] = {
        dealerPos = vector3(1145.74, 261.81, -51.84),
        dealerHeading = 222.2,
    ...
    [4] = {
        ...
        tableHeading = 135.3094329834,
        distance = 1000.0,
        prop = -2126678982
    },
    [5] = {
        dealerPos = vector3(1134.3,267.29,-51.03),
        dealerHeading = 141.1206,
        tablePos = vector3(1133.74, 266.6947, -52.04094),
        tableHeading = 135.8896,
        distance = 1000.0,
        prop = 618005505
    },
    [6] = {
    ...
    [7] = {
        dealerPos = vector3(1149.34,252.25,-51.03),
        dealerHeading = 133.3609,
        tablePos = vector3(1148.74, 251.6947, -52.04094),
        tableHeading = 315.00009155273,
        distance = 1000.0,
        prop = 618005505
    },
}
...
RegisterCommand("getcasinotable",function()
    ...
    if DoesEntityExist(blackjackTable) then
        ...
        print(GetHashKey("vw_prop_casino_blckjack_01"))
        vRP.prompt("table:","tablePos pos: "..GetEntityCoords(blackjackTable).."\ntableHeading heading: "..GetEntityHeading(blackjackTable).."\n".."hashkey: "..GetHashKey("vw_prop_casino_blckjack_01"))
    else
        ...
        if DoesEntityExist(blackjackTable2) then
            ...
            print(GetHashKey("vw_prop_casino_blckjack_01b"))
            vRP.prompt("table:","tablePos pos: "..GetEntityCoords(blackjackTable2).."\ntableHeading heading: "..GetEntityHeading(blackjackTable2).."\n".."hashkey: "..GetHashKey("vw_prop_casino_blckjack_01b"))
        else
            local blackjackTable3 = GetClosestObjectOfType(playerCoords.x,playerCoords.y,playerCoords.z,3.0,-1728077103,0,0,0)
            if DoesEntityExist(blackjackTable3) then
                print("Found entity")
                print("tablePos pos:",GetEntityCoords(blackjackTable3))
                print("tableHeading heading:",GetEntityHeading(blackjackTable3))
                print("prop: -1728077103")
                vRP.prompt("table:","tablePos pos: "..GetEntityCoords(blackjackTable3).."\ntableHeading heading: "..GetEntityHeading(blackjackTable3).."\n".."hashkey: -1728077103")
            else
                local blackjackTable4 = GetClosestObjectOfType(playerCoords.x,playerCoords.y,playerCoords.z,3.0,618005505,0,0,0)
                if DoesEntityExist(blackjackTable4) then
                    print("Found entity")
                    print("tablePos pos:",GetEntityCoords(blackjackTable4))
                    print("tableHeading heading:",GetEntityHeading(blackjackTable4))
                    print("prop: -1728077103")
                    vRP.prompt("table:","tablePos pos: "..GetEntityCoords(blackjackTable4).."\ntableHeading heading: "..GetEntityHeading(blackjackTable4).."\n".."hashkey: 618005505")
                else
...
Citizen.CreateThread(function()
    while true do 
        if closeToCasino then
            ...
            closestChair = -1
            local playerCoords = GetEntityCoords(GetPlayerPed(-1))
            -- print(((#cfg.blackjackTables+1)*4)-1)
            -- print((#cfg.blackjackTables+1)*4)
